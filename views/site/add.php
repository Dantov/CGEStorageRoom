...
$modelStatus = (int)$stockData['item_status']; 
    ...
    <h4 class="tittle-w3-agileits mb-4"><i class="fa-regular fa-file-lines"></i> General data</h4>
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                <label for="item_quantity"><i class="fa-solid fa-calculator"></i> Quantity</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text badge-light"><i class="fa-regular fa-square-full"></i></div>
                    </div>
                    <input type="number" min="1" editable class="form-control" name="item_quantity" id="item_quantity" value="<?=$stockData['item_quantity']?>"placeholder="">
                </div>
            </div>
            <div class="form-group col-md-3">
                <label for="item_size">Item size mm</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text badge-light"><i class="fa-regular fa-square-full"></i></div>
                    </div>
...
<div class="outer-w3-agile mt-3">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text badge-light">
                        <small>Added by: <?=User::getUsernameByID($stockData['creator_id'])?></small>
                    </div>
                </div>
    ...
    <div class="form-group row" id="publishRow">
        ...
        <div class="col-sm-4">
            <?php if ( $modelStatus !== 2 ): ?>
                <a class="btn btn-outline-danger" href="<?=Url::to(["site/view", 'id'=>$stockData['id']])?>" role="button"><i class="fa-solid fa-eye"></i> View</a>
                <a class="btn btn-outline-warning float-right" id="clone-position" role="button">Clone</a>
